    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Incoming Mail</h3>
                <p class="text-subtitle text-muted">For Incoming Mail to check they list</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="/">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Incoming Mail</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/addmail" method="post" style="width:100%" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" class="form-control" name="jenis_surat" value="masuk">
                                    <div class="form-group has-icon-left" style="width: 100%">
